...
<head>
    ...
    <title>Nomination For   
 Fellow Institute of Business Development</title>
    <style>
        body {
...
<body>
    <div class="text-content">
        ...
        <p><b>Air Commodore {{$first_name}} {{$othernames}}</b></p>
        <p>Dear Sir,</p>
    ...
    <div class="second-page-content">
        ...
        <p style="margin-bottom: 0;">Payments can be made through the account details provided below: <br/>

        <b>Account Name:</b> The Institute of Business Development<br/>
...
<table width="100%">
    <tr>
        ...
        <!-- <img class="bottom" src="{{ public_path('images/footer.png') }}" alt="Bottom Image"> -->
    </div>
</body>
</html>