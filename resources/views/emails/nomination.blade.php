		...
		<td class="header container" align="">
			...
			<div class="content">
				<table bgcolor="#999999" >
					<tr>
						<td><img src="https://ibd.ecolemoderne.com/images/ibd-logo.png" width="50%" height="auto"/></td>
						<td align="right"><h6 class="collapse">NOMINATION FOR THE AWARD OF FELLOW OF THE INSTITUTE OF BUSINESS DEVELOPMENT AND INVITATION TO ATTEND OUR 9TH NATIONAL CONFERENCE</h6></td>
					</tr>
				</table>
			</div><!-- /content -->
				...
				<table>
					<tr>
						<td>
							...
							<h1>{{$title}} {{$first_name}} {{$othernames}}</h1>
							<p class="lead">Dear Sir</p>
							
							<!-- A Real Hero (and a real human being) -->
							<p><img src="https://ibd.ecolemoderne.com/images/header.png" width="600" height="300"/></p><!-- /hero -->
